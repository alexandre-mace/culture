...
export const navigationCategories = [
  {
    ...
    items: [
      ...
      { name: "Mathématiques", href: "/mathematiques" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Littérature", href: "/litterature" },
      ...
      { name: "Arts décoratifs", href: "/arts-decoratifs" },
    ],
  },
  {
    name: "Société",
    items: [
      ...
      { name: "Démocratie", href: "/democratie" },
      { name: "Droits civiques", href: "/droits-civiques" },
      { name: "Révolutions industrielles", href: "/revolutions-industrielles" },
...
const dataCategories = [
  ...
  { data: writers, href: "/litterature", name: "Littérature" },
  { data: painters, href: "/peinture", name: "Peinture" },
  { data: filmmakers, href: "/cinema", name: "Cinéma" },
  ...
  { data: medicine, href: "/medecine", name: "Médecine" },
  ...
  { data: industrialRevolutions, href: "/revolutions-industrielles", name: "Révolutions industrielles" },
  { data: epochs, href: "/epoques", name: "Époques" },
  { data: pandemics, href: "/pandemies", name: "Pandémies" },
  { data: civilRights, href: "/droits-civiques", name: "Droits civiques" },
  { data: democracy, href: "/democratie", name: "Démocratie" },
